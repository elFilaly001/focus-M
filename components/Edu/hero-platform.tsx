...
export default function HeroPlatform() {
  ...
  useEffect(() => {
    ...
    const startDrawing = (e: MouseEvent | TouchEvent) => {
      ...
      if (isMobile) {
        ...
        const btnSection = container?.querySelector(
          ".mobile-draw-limit"
        ) as HTMLElement;
        if (btnSection) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative select-none bg-background min-h-screen overflow-auto"
    >
      <canvas
        ref={canvasRef}
        ...
        <div className="container px-4 pt-32 pb-20 md:py-20 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              Toucher l’avenir 
              <br />
              <span className="text-[#dc2626]">apprendre autrement</span>
            </motion.h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-20 mobile-draw-limit">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="text-lg px-8 h-14 border-2 hover:bg-gray-200 "
              >
                <Link href="/education/solutions">Nos solutions</Link>
              </Button>
            </div>
          </div>
        </div>
