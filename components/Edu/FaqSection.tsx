              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="faq1" className="border-0">
                  ...
                  <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                    Oui, nos solutions sont conçues avec des mesures de sécurité avancées et une interface intuitive pour une gestion facile.
                  </AccordionContent>
                </AccordionItem>
                {/* FAQ Item 2 */}
                <AccordionItem value="faq2" className="border-0">
                  ...
                  <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                    Absolument, nos plateformes supportent le travail à distance et hybride avec des outils de collaboration intégrés.
                  </AccordionContent>
                </AccordionItem>
                {/* FAQ Item 3 */}
                <AccordionItem value="faq3" className="border-0">
                  <div className="flex items-center py-10">
                    ...
                    <AccordionTrigger className="flex-1 text-lg font-medium text-left px-2 py-0 bg-transparent shadow-none hover:bg-transparent focus:outline-none">
                      Vos solutions sont-ils adaptés aux élèves ayant des besoins spécifiques ?
                    </AccordionTrigger>
                  </div>
                  <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                ...
                <AccordionItem value="faq4" className="border-0">
                  ...
                  <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                    Oui, nous proposons un accompagnement complet pour l'installation et la configuration de nos solutions.
                  </AccordionContent>
                </AccordionItem>
                {/* FAQ Item 5 */}
                <AccordionItem value="faq5" className="border-0">
                  ...
                  <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                    Oui, nos solutions sont conçues pour être inclusives et adaptées aux élèves ayant des besoins spécifiques, avec des fonctionnalités d'accessibilité.
                  </AccordionContent>
                </AccordionItem>
                {/* FAQ Item 6 */}
                ...
                <AccordionItem value="faq8" className="border-0">
                  <div className="flex items-center py-10">
                    <span className="text-xl font-semibold text-muted-foreground w-12 flex-shrink-0">08</span>
                    <AccordionTrigger className="flex-1 text-lg font-medium text-left px-2 py-0 bg-transparent shadow-none hover:bg-transparent focus:outline-none">
                ...
                <AccordionItem value="faq9" className="border-0">
                  <div className="flex items-center py-10">
                    <span className="text-xl font-semibold text-muted-foreground w-12 flex-shrink-0">09</span>
                    <AccordionTrigger className="flex-1 text-lg font-medium text-left px-2 py-0 bg-transparent shadow-none hover:bg-transparent focus:outline-none">
                ...
                <AccordionItem value="faq10" className="border-0">
                  <div className="flex items-center py-10">
                    <span className="text-xl font-semibold text-muted-foreground w-12 flex-shrink-0">10</span>
                    <AccordionTrigger className="flex-1 text-lg font-medium text-left px-2 py-0 bg-transparent shadow-none hover:bg-transparent focus:outline-none">
                ...
                <AccordionItem value="faq11" className="border-0">
                  <div className="flex items-center py-10">
                    <span className="text-xl font-semibold text-muted-foreground w-12 flex-shrink-0">11</span>
                    <AccordionTrigger className="flex-1 text-lg font-medium text-left px-2 py-0 bg-transparent shadow-none hover:bg-transparent focus:outline-none">
