...
import { Download, Monitor, Wrench, Camera, LayoutGrid } from "lucide-react"
...
const downloadCategories = [
  {
    ...
    products: [
      ...
      { name: "Écran i3 Sixty 3", file: "/Fiches%20techniques/FR_i3SIXTY3_ProductBrochure.pdf" },
    ],
  },
  {
    id: "accessoires",
    ...
    icon: Wrench,
    products: [
      { name: "Support mobile i3LYFT", file: "/Fiches%20techniques/i3LYFT_M-French.pdf" },
      { name: "i3FLEX (55 & 105 pouces)", file: "/Fiches%20techniques/FT-i3FLEX-55&105%20pouce.pdf" },
      { name: "i3CAMERA Full HD", file: "/Fiches%20techniques/FT_i3CAMERA_FHD.pdf" },
      { name: "i3CAMERA Pro 4K", file: "/Fiches%20techniques/FT_i3CAMERA-Pro-4K.pdf" },
      { name: "i3COMPUTER (OPS)", file: "/Fiches%20techniques/FT-OPS%20512%20-%20712%20(1)%20(1).pdf" },
      { name: "Adaptateurs i3ALLSYNC", file: "/Fiches%20techniques/FT-i3ALLSYNC.pdf" },
    ],
  },
  {
    id: "ipevo",
  ...
  },
  {
    ...
    icon: LayoutGrid,
    products: [
      { name: "Tableaux mobiles coulissants", file: "/Fiches%20techniques/FT%20TABLEAU%20BLANC%20COULISSANT.pdf" },
    ],
  },
]
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
              Téléchargements & <span className="text-[#C52133]">Ressources</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              Accédez aux fiches techniques de tous nos produits. Téléchargez les documentations PDF pour en savoir plus sur nos solutions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button asChild size="lg" className="bg-[#C52133] hover:bg-[#991b1b] text-white">
            <Link href="/entreprise/contact">Nous contacter</Link>
          </Button>
        </div>
      </section>
    </div>
