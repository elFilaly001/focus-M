...
export const metadata = {
  ...
  description: "Questions fréquemment posées sur les solutions FocusTech pour les entreprises."
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="flex flex-col justify-center h-full">
              ...
              <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8">
                Découvrez nos solutions interactives conçues pour les entreprises modernes.
              </p>
                ...
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq1" className="border-0">
                    <div className="flex items-center py-10">
                      ...
                      <AccordionTrigger className="flex-1 text-lg font-medium text-left px-2 py-0 bg-transparent shadow-none hover:bg-transparent focus:outline-none">
                        Quels sont les avantages des solutions FocusTech pour les entreprises ?
                      </AccordionTrigger>
                    </div>
                    <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                      Nos solutions offrent une collaboration améliorée, une sécurité renforcée et une intégration facile avec vos outils existants.
                    </AccordionContent>
                  </AccordionItem>
                  {/* FAQ Item 2 */}
                  <AccordionItem value="faq2" className="border-0">
                    <div className="flex items-center py-10">
                      ...
                      <AccordionTrigger className="flex-1 text-lg font-medium text-left px-2 py-0 bg-transparent shadow-none hover:bg-transparent focus:outline-none">
                        Proposez-vous des démonstrations personnalisées pour les entreprises ?
                      </AccordionTrigger>
                    </div>
                    <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                      Oui, nous organisons des démonstrations adaptées à vos besoins spécifiques. Contactez-nous pour planifier une session.
                    </AccordionContent>
                  </AccordionItem>
                  {/* FAQ Item 3 */}
                  <AccordionItem value="faq3" className="border-0">
                    <div className="flex items-center py-10">
                      ...
                      <AccordionTrigger className="flex-1 text-lg font-medium text-left px-2 py-0 bg-transparent shadow-none hover:bg-transparent focus:outline-none">
                        Les solutions FocusTech sont-elles compatibles avec les outils de visioconférence ?
                      </AccordionTrigger>
                    </div>
                    <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                      Oui, nos solutions sont compatibles avec les principales plateformes de visioconférence comme Zoom, Teams et Google Meet.
                    </AccordionContent>
                  </AccordionItem>
                  {/* FAQ Item 4 */}
                  <AccordionItem value="faq4" className="border-0">
                    <div className="flex items-center py-10">
                      ...
                      <AccordionTrigger className="flex-1 text-lg font-medium text-left px-2 py-0 bg-transparent shadow-none hover:bg-transparent focus:outline-none">
                        Offrez-vous une assistance technique dédiée aux entreprises ?
                      </AccordionTrigger>
                    </div>
                    <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                      Oui, une équipe dédiée est disponible pour accompagner nos clients professionnels 24h/24 et 7j/7.
                    </AccordionContent>
                  </AccordionItem>
                  {/* FAQ Item 5 */}
                  <AccordionItem value="faq5" className="border-0">
                    ...
                    <AccordionContent className="pl-14 pb-6 text-muted-foreground">
                      Remplissez notre formulaire de contact ou appelez-nous pour recevoir un devis adapté à votre entreprise.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </div>
