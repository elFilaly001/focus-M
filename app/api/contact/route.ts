                ...
                <table width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td style="background-color: #C52133; padding: 30px 40px; text-align: center;">
                      ...
                      <p style="margin: 8px 0 0 0; color: #ffffff; font-size: 14px; opacity: 0.9;">Nouvelle Soumission de Formulaire de Contact</p>
                    </td>
                  </tr>
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                          <td style="padding-bottom: 24px;">
                            <table width="100%" cellpadding="8" cellspacing="0" style="border: 1px solid #e5e7eb; border-radius: 6px;">
                              <tr>
                                <td style="background-color: #f9fafb; font-weight: 600; color: #162030; width: 140px; border-bottom: 1px solid #e5e7eb;">Nom</td>
                              ...
                              <tr>
                                ...
                                <td style="color: #374151; border-bottom: 1px solid #e5e7eb;">${phone || 'Non fourni'}</td>
                              </tr>
                              <tr>
                                <td style="background-color: #f9fafb; font-weight: 600; color: #162030;">Entreprise</td>
                                <td style="color: #374151;">${company || 'Non fourni'}</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td style="padding-bottom: 16px;">
                            <h2 style="margin: 0 0 12px 0; color: #162030; font-size: 16px; font-weight: 600;">Message</h2>
                  ...
                  <tr>
                    <td style="background-color: #162030; padding: 24px 40px; text-align: center;">
                      <p style="margin: 0; color: #ffffff; font-size: 12px; opacity: 0.8;">Cet email a été envoyé depuis votre formulaire de contact FocusM</p>
