...
export default function Page() {
  return (
    <><div className="mb-8">
      <HeroSolution />
    </div><HowItWorks className="mb-10 px-4 md:px-12" /><div className="px-8 md:px-32">
        <div className="mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-12">
          {eduSolutions.map((item, i) => (
            <motion.div
              ...
              className={"w-full p-0 md:p-0 bg-white dark:bg-[#162030] border border-gray-100 dark:border-gray-900 rounded-xl shadow transition-shadow flex flex-col items-stretch gap-0"}
            >
              {/* Unsplash image */}
