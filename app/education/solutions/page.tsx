  ...
  return (
    <>
      ...
      <div className="px-8 md:px-32">
        <div className="mb-2">
          <span className="text-xs sm:text-sm font-semibold text-[var(--color-primary)] uppercase tracking-wide mb-3 sm:mb-4 block">
            Solutions interactives
          </span>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#162030] dark:text-white mb-3 sm:mb-4 leading-tight">
            Des solutions pour chaque salle de classe
          </h2>
          <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 max-w-2xl mb-2">
            Découvrez nos fonctionnalités phares pour dynamiser l'apprentissage,
            encourager la collaboration et garantir la sécurité dans les
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-12">
          {eduSolutions.map((item, i) => (
            <motion.div
              ...
              className={
                "w-full p-0 md:p-0 bg-white dark:bg-[#080c13] border border-gray-100 dark:border-gray-900 rounded-xl shadow transition-shadow flex flex-col items-stretch gap-0"
              }
            >
              {/* Unsplash image */}
              ...
              <div className="flex-1 text-center flex flex-col items-center px-6 md:px-8 py-6 md:py-8">
                ...
                <h3 className="text-lg font-semibold mb-2 text-[#162030] dark:text-white">
                  {item.title}
                </h3>
